<?php /* Smarty version 3.1.27, created on 2017-09-03 01:58:53
         compiled from "D:\wamp\www\templates\mobile_104\list_game.php" */ ?>
<?php
/*%%SmartyHeaderCode:249359ab61dd3de416_08959426%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fde98d04d1ea0654fd82ae814442bd52a546f73a' => 
    array (
      0 => 'D:\\wamp\\www\\templates\\mobile_104\\list_game.php',
      1 => 1504321876,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '249359ab61dd3de416_08959426',
  'variables' => 
  array (
    'cate_id' => 0,
    'row' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59ab61dd667517_46402960',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59ab61dd667517_46402960')) {
function content_59ab61dd667517_46402960 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '249359ab61dd3de416_08959426';
?>
<!DOCTYPE HTML>
<html>
<head>
...
images/search.png"></a>
    ...
    <div class="ly-ta">
        <div class="banner">
            ...
            <div class="bd">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>46,'row'=>3,'start'=>0)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>46,'row'=>3,'start'=>0), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">立即下载</a>
                ...
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>46,'row'=>3,'start'=>0), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <div id="rank_hot" data-id="46">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>46,'row'=>15,'start'=>3)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>46,'row'=>15,'start'=>3), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="col-4FB0E4 btn-a">立即下载</a></p>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>46,'row'=>15,'start'=>3), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <div class="range">
            <table class="fs20" border="1" width="0" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('appnav', array('parent'=>2,'row'=>3,'start'=>0)); $_block_repeat=true; echo smarty_block_appnav(array('parent'=>2,'row'=>3,'start'=>0), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">&nbsp;<span><?php echo $_smarty_tpl->tpl_vars['appnav']->value['cname'];?>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_appnav(array('parent'=>2,'row'=>3,'start'=>0), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
$_smarty_tpl->tpl_vars['foo']->first = $_smarty_tpl->tpl_vars['foo']->iteration == 1;$_smarty_tpl->tpl_vars['foo']->last = $_smarty_tpl->tpl_vars['foo']->iteration == $_smarty_tpl->tpl_vars['foo']->total;?>
                <tr>
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('appnav', array('parent'=>2,'row'=>4,'start'=>$_smarty_tpl->tpl_vars['foo']->value*4-1)); $_block_repeat=true; echo smarty_block_appnav(array('parent'=>2,'row'=>4,'start'=>$_smarty_tpl->tpl_vars['foo']->value*4-1), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">&nbsp;<span><?php echo $_smarty_tpl->tpl_vars['appnav']->value['cname'];?>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_appnav(array('parent'=>2,'row'=>4,'start'=>$_smarty_tpl->tpl_vars['foo']->value*4-1), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
" data-parent="2">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('applist', array('id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'start'=>0,'page'=>$_smarty_tpl->tpl_vars['page']->value,'per_page'=>15,'parent'=>2)); $_block_repeat=true; echo smarty_block_applist(array('id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'start'=>0,'page'=>$_smarty_tpl->tpl_vars['page']->value,'per_page'=>15,'parent'=>2), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
次下载<span class="none"> | <?php echo round($_smarty_tpl->tpl_vars['applist']->value['history_size']/1024/1024,2);?>
MB</span></li>
...
" class="col-4FB0E4 btn-a">立即下载</a></p>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_applist(array('id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'start'=>0,'page'=>$_smarty_tpl->tpl_vars['page']->value,'per_page'=>15,'parent'=>2), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <div class="ly-ta" style="display:none;" >
        <div id="rankW" data-id="52">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>52,'row'=>3,'start'=>0)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>52,'row'=>3,'start'=>0), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="col-4FB0E4 btn-a">立即下载</a></p>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>52,'row'=>3,'start'=>0), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>


            <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>52,'row'=>12,'start'=>3)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>52,'row'=>12,'start'=>3), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="col-4FB0E4 btn-a">立即下载</a></p>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>52,'row'=>12,'start'=>3), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
