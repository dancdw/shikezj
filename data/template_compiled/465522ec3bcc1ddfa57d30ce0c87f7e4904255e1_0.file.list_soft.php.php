<?php /* Smarty version 3.1.27, created on 2017-08-20 07:44:31
         compiled from "D:\wamp\www\templates\mobile_103\list_soft.php" */ ?>
<?php
/*%%SmartyHeaderCode:2789159993ddf56c994_17575454%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '465522ec3bcc1ddfa57d30ce0c87f7e4904255e1' => 
    array (
      0 => 'D:\\wamp\\www\\templates\\mobile_103\\list_soft.php',
      1 => 1500969782,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2789159993ddf56c994_17575454',
  'variables' => 
  array (
    'cate_id' => 0,
    'row' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59993ddf9812c1_67375761',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59993ddf9812c1_67375761')) {
function content_59993ddf9812c1_67375761 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '2789159993ddf56c994_17575454';
?>
<!DOCTYPE html>
<html>
<head>
...
?>
    ...
    <div id="bd">
        ...
        <!--热门-->
        <DIV class="soft_list" id="section_hot_soft" data-id="45">
            <ul  id="soft">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>"45",'row'=>10)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>"45",'row'=>10), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="down"><span>下载</span></a>
        ...
        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>"45",'row'=>10), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <!--精品-->
    <DIV class="soft_list" id="section_hot_game" style="display: none;" data-id="47">
        <ul id="game">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>"47",'row'=>10)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>"47",'row'=>10), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="down"> <span>下载</span>
    ...
    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>"47",'row'=>10), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<!--排行-->
<div id="section_hot_rank" style="display: none;" class="soft_list" data-id="51">
    <ul id="rank">
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>"51",'row'=>10)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>"51",'row'=>10), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>"51",'row'=>10), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
