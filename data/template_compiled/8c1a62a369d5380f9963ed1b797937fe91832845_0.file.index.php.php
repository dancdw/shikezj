<?php /* Smarty version 3.1.27, created on 2017-08-21 07:10:02
         compiled from "D:\wamp\www\shikezj\templates\mobile_106\index.php" */ ?>
<?php
/*%%SmartyHeaderCode:14827599a874a708bf0_97149393%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c1a62a369d5380f9963ed1b797937fe91832845' => 
    array (
      0 => 'D:\\wamp\\www\\shikezj\\templates\\mobile_106\\index.php',
      1 => 1503237619,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14827599a874a708bf0_97149393',
  'variables' => 
  array (
    'setting' => 0,
    'tpl_path' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_599a874a7d64d3_32302943',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_599a874a7d64d3_32302943')) {
function content_599a874a7d64d3_32302943 ($_smarty_tpl) {
if (!is_callable('smarty_block_ad')) require_once 'D:\\wamp\\www\\shikezj\\cms\\libraries\\Template\\plugins\\block.ad.php';
if (!is_callable('smarty_block_recommend')) require_once 'D:\\wamp\\www\\shikezj\\cms\\libraries\\Template\\plugins\\block.recommend.php';
if (!is_callable('smarty_function_link')) require_once 'D:\\wamp\\www\\shikezj\\cms\\libraries\\Template\\plugins\\function.link.php';
if (!is_callable('smarty_function_countdown')) require_once 'D:\\wamp\\www\\shikezj\\cms\\libraries\\Template\\plugins\\function.countdown.php';

$_smarty_tpl->properties['nocache_hash'] = '14827599a874a708bf0_97149393';
?>
<!DOCTYPE HTML>
<html>
<head>
...
"  style="width: 375px; height:114px"/></a></li>
  ...
  <div class="clr"></div>
  <div id="insert1"></div>
  <marquee direction="left" align="bottom" height="25" width="100%" onmouseout="this.start()" onmouseover="this.stop()" scrollamount="2" scrolldelay="1" style="height:25px; line-height:25px;white-space: nowrap;">
  <font color="#FF0000">任务攻略：以下所有平台都是独立的，每个平台都有任务，所有平台都玩，收入才会更多哦。另外每天各平台任务更新时间在下午3-6点，4点最多哦！</font>
  </marquee>
  <div class="hotspot_ranking" id="a1" style="display: block;">
    ...
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>45,'row'=>16)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>45,'row'=>16), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" width="50px" height="50px"> </div>
        <div class="float ranking-text-list">
          <div class="ranking-text1">任务平台-<?php echo $_smarty_tpl->tpl_vars['recommend']->value['app_title'];?>
</div>
          <div class="ranking-text2"><?php echo $_smarty_tpl->tpl_vars['recommend']->value['app_seodesc'];?>
</div>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>45,'row'=>16), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<!-- Mirrored from wap.xw.lazixiu.top/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Aug 2017 10:12:51 GMT -->
</html>
﻿
<!-- /footer -->
</body>
