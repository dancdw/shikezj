...
<div class="container">
    ...
    <div class="gray-head-bg2">
        <header class="search-input">
            ...
            <p class="search-bg">
                <input type="text" id="search-input" value="请输入搜索内容" onFocus="if(value=='请输入搜索内容'){value='';this.style.color='javascript:;333'}" onBlur="if(value==''){value='请输入搜索内容'}" class="search i-search"  data-rewrite="<!--{$setting.is_site_rewrite}-->">
    ...
    <div class="ly-ta">
        ...
        <div id="rank_hot" data-id="45">
            <!--{recommend id=45 row=15 start=3}-->
            <div class="game">
                <div class="game-pic">
    ...
    <div class="ly-ta" style="display:none;" >
        <div id="rankS" data-id="47">
            <!--{recommend id=47 row=15 start=0}-->
            <div class="game">
                <div class="game-pic">
                    <div class="fl"><a href="<!--{link m='app' app_id=$recommend.app_id}-->"><img src="<!--{imageurl url = $recommend.app_logo}-->" style="height:72px;width:72px;"/></a></div>
                    <a href="<!--{link m='app' app_id=$recommend.app_id}-->">
    ...
    <div class="ly-ta" style="display:none;" >
        <div class="range">
            <table class="fs20" border="1" width="0" border="0" cellspacing="0" cellpadding="0">
                ...
                <!--{for $foo=1 to 4 }-->
                <tr>
                    <!--{appnav parent=1 row=4 start=$foo*4-1}-->
                    <td>
                        <a href="<!--{link m='categories' cate_id=$appnav.cate_id}-->" title="<!--{$appnav.cname}-->">
                            <img src="<!--{imageurl url = $appnav.cate_logo}-->">&nbsp;<span><!--{$appnav.cname}--></span>
                        </a>
        ...
        <div id="categary_hot_soft"  data-id="<!--{$cate_id}-->" data-parent="1">
            <!--{applist  id=$cate_id start=0 page=$page per_page=15 parent=1 }-->
            <div class="game" >
                <div class="game-pic">
                    <div class="fl">
                    ...
                    <ul>
                        ...
                        <li class="fs12 col-999">
                            <!--{countdown down=$applist.app_down}-->次下载<span class="m-none">| <!--{round($applist.history_size/1024/1024,2)}-->M</span></li>
                        <li class="fs12 col-666"><span class="btn-s col-999"><!--{$applist.cname}--></span></li>
                    </ul>
                    </a>
    ...
    <div class="ly-ta" style="display:none;" >
        <div id="rankW" data-id="51">
            ...
            <!--{recommend id=51 row=12 start=3}-->
            <div class="game">
