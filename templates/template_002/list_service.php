...
<div id="main" class="layout">
        ...
        <div class="mt30">
            <ul class="k-title">
                ...
                <li class="fr">
                    <!--{if !$o_type_id}-->
                    <a href="<!--{link m='services'}-->" class="ly-current">全部</a>
                    <!--{else}-->
                    <a href="<!--{link m='services'}-->">全部</a>
                    <!--{/if}-->
                    <!--{otimenav}-->
                    <!--{if $o_type_id == $otimenav.t_id}-->
                    <a href="<!--{link m='services' o_type_id = $otimenav.t_id}-->" class="ly-current"><!--{$otimenav.t_name}--></a>
                    <!--{else}-->
                    <a href="<!--{link m='services' o_type_id = $otimenav.t_id}-->"><!--{$otimenav.t_name}--></a>
                    <!--{/if}-->
                    <!--{/otimenav}-->
                </li>
            </ul>
