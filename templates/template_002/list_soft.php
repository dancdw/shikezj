    ...
    <div class="inner">
        <div class="leibie">
            <div class="clearfix"><p class="leibie_l">软件类别：</p>
                ...
                <p class="leibie_r"><a href="<!--{link m='softs'}-->" <!--{if $cate_id>0}--><!--{else}-->class="dangqian"<!--{/if}-->><em>全部</em></a>
                    <!--{appnav parent=1}-->
                    <a href="<!--{link m='softs' cate_id=$appnav.cate_id}-->"  <!--{if $cate_id == $appnav.cate_id}-->class="dangqian"<!--{/if}-->><em>  <!--{$appnav.cname}--></em></a>
                    <!--{/appnav}-->
        ...
        <div class="box gamebox">
            <ul class="ifenlei clearfix">
                <!--{applist page=$page parent=1 id=$cate_id row=24 per_page=24}-->
                <li>
            ...
            <!--{pagebar name='applist' page=$page parent=1 id=$cate_id row=24 per_page=24}-->
        </div>
    </div>
    <!--/ inner -->
