...
<div class="pad10 mart14">
    <table width="0" border="0" cellspacing="0" cellpadding="0" class="table">
        <tbody>
        <tr>
            <td><a href="<!--{link m='softs'}-->" title="全部"><span>全部</span></a> </td>
            <!--{appnav parent=1 row=3 start=0}-->
            <td>
                <a href="<!--{link m='softs' cate_id=$appnav.cate_id}-->" title="<!--{$appnav.cname}-->">
...
<div class="rank-box-div block list-box">
    <ul class="rank">
        <!--{applist parent=1 id=$cate_id row=3}-->
        <li>
    ...
    <div class="rank-list">
        <ul class="speApp" id="categary_hot_soft" data-id="<!--{$cate_id}-->">
            <!--{applist parent=1 id=$cate_id start2=3 page=$page per_page=12 }-->
            <li>
