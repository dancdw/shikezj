...
<div class="content clearfix">
    <div class="left">
        <div class="crumb02">
            <p class="pos">当前位置：<a href="/">首页</a><b>&gt;</b><a href="<!--{link m='games'}-->">安卓游戏</a><!--{if $cate_id}-->
                <!--{row name='app_category' id=$cate_id}--><b>&gt;</b><a
                    href="<!--{link m='games' cate_id=$cate_id}-->"><!--{$row.cname}--></a><!--{/row}--><!--{/if}-->
            </p>
        </div>
        <div class="list-title clearfix" style="padding-left:0">
            <h2 class="con" title="安卓软件"><span class="title-bg iconSprite"></span>安卓游戏</h2>
        </div>
        <div class="tab-1 clearfix">
            <ul>
                <li<!--{if $order == 0}--> class="current" <!--{/if}-->>
                <span></span><a href="<!--{link m='games' cate_id=$cate_id page=$page}-->" title="安卓最新软件">最新</a>
                </li>

                <li<!--{if $order == 1}--> class="current" <!--{/if}-->>
                <span></span><a href="<!--{link m='games' cate_id=$cate_id order=1 page=$page}-->" title="安卓最热软件">最热</a>
                </li>

                <li<!--{if $order == 2}--> class="current" <!--{/if}-->>
                <span></span><a href="<!--{link m='games' cate_id=$cate_id order=2 page=$page}-->" title="安卓五星软件">评分</a>
                </li>
            </ul>
        </div>
        ...
        <div>
            <div class="ly-tab">
                <!--{applist parent=2 id=$cate_id order=$order_by page=$page per_page=14}-->
                <ul class="app-list">
                    <li class="first  list-li">
                        <div class="border-out-2"></div>
                        <div class="list-in" style="margin-top:2px;">
                            <div class="list-left">
                                ...
                                <div class="app-v">
                                    ...
                                    <p class="update-time"><!--{$applist.app_update_time|date_format:"%y/%m/%d"}--><i class="up-icon-1 iconSprite"></i></p>
                                </div>
                                <div class="app-h">
                            ...
                            <div class="list-right">
                                ...
                                <p class="g-desc">
                                    <a href="<!--{link m='app' app_id=$applist.app_id}-->" title="安卓安全保密" target="_blank">安全保密</a>
                                </p>
                                <p class="g-detail">
                                    <span><!--{$applist.app_update_time|date_format:"%m-%d"}--></span> |
                                    <!--{round($applist.history_size/1024/1024/2)}-->MB
                                </p>
                                <p class="down-ac">版本：<!--{$applist.history_version}--></p>

                                <p><!--{$applist.app_desc}--></p>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="page">
            <!--{pagebar name='applist' parent=2 id=$cate_id page=$page per_page=14 order=$order_by}-->
        </div>
            ...
            <div class="div-out">
                <div class="right-ul-bd">
                    <ul class="game-lx">
                        ...
                        <a href="<!--{link m='games'}-->" title="全部">全部</a>
                        </li>
                        <!--{appnav parent=2}-->
                        <li
                        <!--{if $cate_id == $appnav.cate_id}-->class="cur"<!--{/if}--> >
                        <a href="<!--{link m='games' cate_id=$appnav.cate_id}-->"><!--{$appnav.cname}--></a>
                        </li>
                        <!--{/appnav}-->
                    </ul>
                </div>
