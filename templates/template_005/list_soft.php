...
<div class="main">
    <div class="wp">
        ...
        <dl class="sort_box">
            ...
            <dd>
                <a href="<!--{link m='softs'}-->" <!--{if empty($cate_id)}-->class="current"
                <!--{/if}-->>全部</a>
                <!--{appnav parent=1}-->
                <a href="<!--{link m='softs' cate_id=$appnav.cate_id}-->"
        ...
        <div class="row row_list">
            <div class="article">
                ...
                <div id="Mlist" class="Mlist">
                    <!--{applist parent=1 id=$cate_id page=$page row=10 per_page=10}-->
                    <div class="list_item">
                        <div class="Mimg">
                ...
                <div class="page" style="text-align: center;">
                    <!--{pagebar name='applist' parent=1 id=$cate_id page=$page per_page=10}-->
                </div>
                <!--分页 end-->
            </div>
            <!--边栏  start-->
