    ...
    <div class="app-box">
        <div class="mod-cate-property">
            <div class="mod-cate clearfix">
                ...
                <div class="bd">
                    <ul>
                        <li><a href="<!--{link m='games'}-->" <!--{if empty($cate_id)}-->class="selected"
                            <!--{/if}-->>全部</a></li>
                        <!--{appnav parent=2}-->
                        <li><a href="<!--{link m='games' cate_id=$appnav.cate_id}-->"
        ...
        <div class="mod mod-cate-list" id="js-tab">
            <div class="bd js-views">
                <div class="mod-pro-list">
                    <ul>
                        <!--{applist parent=2 id=$cate_id page=$page row=32 per_page=32}-->
                        <li class="">
            ...
            <div class="ft">
                <!--{pagebar name='applist' parent=2 id=$cate_id page=$page per_page=32 url='more_game'}-->
            </div>
        </div>
    </div>
