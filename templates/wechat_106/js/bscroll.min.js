  ...
  var BScroll$1 = (function(_EventEmitter) {
    ...
    function BScroll(el, options) {
      ...
      var _this = possibleConstructorReturn(
        this,
        (BScroll.__proto__ || Object.getPrototypeOf(BScroll)).call(this)
      );
      ...
      _this.translateZ =
        _this.options.HWCompositing && hasPerspective ? " translateZ(0)" : "";

      _this.options.useTransition =
        _this.options.useTransition && hasTransition;
      _this.options.useTransform = _this.options.useTransform && hasTransform;

      _this.options.eventPassthrough =
        _this.options.eventPassthrough === true
          ? "vertical"
          : _this.options.eventPassthrough;
      _this.options.preventDefault =
        !_this.options.eventPassthrough && _this.options.preventDefault;

      // If you want eventPassthrough I have to lock one of the axes
      _this.options.scrollX =
        _this.options.eventPassthrough === "horizontal"
          ? false
          : _this.options.scrollX;
      _this.options.scrollY =
        _this.options.eventPassthrough === "vertical"
          ? false
          : _this.options.scrollY;

      // With eventPassthrough we also need lockDirection mechanism
      _this.options.freeScroll =
        _this.options.freeScroll && !_this.options.eventPassthrough;
      _this.options.directionLockThreshold = _this.options.eventPassthrough
        ? 0
        : _this.options.directionLockThreshold;
      ...
      },
      {
        ...
        value: function _initSnap() {
          ...
          this.on("refresh", function() {
            ...
            if (
              !_this2.wrapperWidth ||
              !_this2.wrapperHeight ||
              !_this2.scrollerWidth ||
              !_this2.scrollerHeight
            ) {
              return;
            }
            ...
            _this2.goToPage(
              _this2.currentPage.pageX || initPage,
              _this2.currentPage.pageY || 0,
              0
            );
            ...
            if (_this2.options.snapThreshold % 1 === 0) {
              ...
              _this2.snapThresholdX = Math.round(
                _this2.pages[_this2.currentPage.pageX][_this2.currentPage.pageY]
                  .width * _this2.options.snapThreshold
              );
              _this2.snapThresholdY = Math.round(
                _this2.pages[_this2.currentPage.pageX][_this2.currentPage.pageY]
                  .height * _this2.options.snapThreshold
              );
            }
          });
          ...
          this.on("scrollEnd", function() {
            if (_this2.options.snapLoop) {
              if (_this2.currentPage.pageX === 0) {
                _this2.goToPage(
                  _this2.pages.length - 2,
                  _this2.currentPage.pageY,
                  0
                );
              }
          ...
          this.on("flick", function() {
            var time =
              _this2.options.snapSpeed ||
              Math.max(
                Math.max(
                  Math.min(Math.abs(_this2.x - _this2.startX), 1000),
                  Math.min(Math.abs(_this2.y - _this2.startY), 1000)
                ),
                300
              );

            _this2.goToPage(
              _this2.currentPage.pageX + _this2.directionX,
              _this2.currentPage.pageY + _this2.directionY,
              time
            );
          });
        }
        ...
        value: function _transitionTime() {
          ...
          if (!time && isBadAndroid) {
            ...
            requestAnimationFrame(function() {
              if (
                _this4.scrollerStyle[style.transitionDuration] === "0.0001ms"
              ) {
