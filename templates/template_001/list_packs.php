        ...
        <div class="mt30">
            <div>
                <ul class="k-title">
                    ...
                    <li class="fr">
                        <!--{if !$p_type_id}-->
                        <a href="<!--{link m='packs' }-->" class="ly-current">全部</a>
                        <!--{else}-->
                        <a href="<!--{link m='packs'}-->">全部</a>
                        <!--{/if}-->
                        <!--{typenav}-->
                        <!--{if $p_type_id == $typenav.id }-->
                        <a href="<!--{link m='packs' p_type_id = $typenav.id}-->" class="ly-current"><!--{$typenav.name}--></a>
                        <!--{else}-->
                        <a href="<!--{link m='packs' p_type_id = $typenav.id}-->"><!--{$typenav.name}--></a>
                        <!--{/if}-->
                        <!--{/typenav}-->
                    </li>
                </ul>
