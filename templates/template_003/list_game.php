    ...
    <div class="game-s">
        ...
        <div class="game-list-page">
            ...
            <div class="sub-nav">
                <p>
                    <span>游戏类型：</span>
                    <a <!--{if $cate_id>0}--><!--{else}-->class="on"<!--{/if}--> href="<!--{link m='games'}-->">不限</a>
                    <!--{appnav parent=2}-->

                    <a <!--{if $cate_id == $appnav.cate_id}-->class="on"<!--{/if}--> href="<!--{link m='games' cate_id=$appnav.cate_id}-->">
                    <!--{$appnav.cname}-->
                    </a>
        ...
        <div class="game-tab-sublist clear" id="gameTabSubList1">
            ...
            <ul class="game-tab-subcon current ">
                <!--{applist parent=2 id=$cate_id page=$page per_page=16}-->
                <li>
                    <div class="clear">
                        ...
                        <div class="game-tab-subcon-detail clear">
                            ...
                            <p><span class="font-gray">游戏大小：</span><span class="font-orange"><!--{round($applist.history_size/1024/1024,2)}-->MB</span>
                            </p>

                            <p><span class="font-gray">游戏类型：</span><!--{$applist.cname}--></p>
                            <a class="btn btn-xl btn-style4" href="<!--{link m='app' app_id=$applist.app_id}-->"
                               title="<!--{$applist.app_title}-->" target="_blank">游戏下载</a>
            ...
            <!--{pagebar name='applist' id=$cate_id parent=2 page=$page per_page=16}-->
        </div>
    </div>
