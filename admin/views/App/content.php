            ...
            <div class="mt10">
                <table class="tb-2" border="1" bordercolor="#cee1ee">
                    ...
                    <tr>
                        ...
                        <td class="td-bg">视频地址：</td>
                        <td class="alignleft">
                            <input type="text" class="ipt ml15" id="app_video_url" name="app_video_url"
                                   value="<?php echo isset($info['app_video_url']) ? $info['app_video_url'] : '';?>"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td-bg">推荐链接：</td>
                        <td class="alignleft">
                            <input type="text" class="ipt ml15" id="app_recomment_url" name="app_recomment_url"
                                   value="<?php echo isset($info['app_recomment_url']) ? $info['app_recomment_url'] : '';?>"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="td-bg">热销：</td>
                        <td class="alignleft">
                            <div class="l">
                                <select id="app_hot" class="ml15" name="app_hot">
                                    <option
                                        value="0" <?php echo isset($info['app_hot']) && $info['app_hot'] == 0 ? 'selected="selected"' : ''; ?>>
                                        否
                                    </option>
                                    <option
                                        value="1" <?php echo isset($info['app_hot']) && $info['app_hot'] == 1 ? 'selected="selected"' : ''; ?>>
                                        是
                                    </option>
                                </select>
                            </div>
                        ...
                        <td class="td-bg">新品：</td>
                        <td class="alignleft">
                            <div class="l">
                                <select id="app_new" class="ml15" name="app_new">
                                    <option
                                        value="0" <?php echo isset($info['app_new']) && $info['app_new'] == 0 ? 'selected="selected"' : ''; ?>>
                                        否
                                    </option>
                                    <option
                                        value="1" <?php echo isset($info['app_new']) && $info['app_new'] == 1 ? 'selected="selected"' : ''; ?>>
                                        是
                                    </option>
                                </select>
                            </div>
