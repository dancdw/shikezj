                ...
                <div class="select-box l">
                    <div class="select-wrap">
                        <select id="parent_id" name="parent_id" class="search_type" onchange="app_category(this)">
                            ...
                            <option value="1" <?php echo $parent_id == 1 ? 'selected="selected"' : ''; ?>>苹果</option>
                            <option value="2" <?php echo $parent_id == 2 ? 'selected="selected"' : ''; ?>>安卓</option>
                        </select>
                    </div>
                </div>
                <div class="select-box l">
                ...
                <?php if (is_array($list) && sizeof($list) > 0) : ?>
                    <?php foreach ($list as $kapp => $vapp) : ?>
                        <tr>
                            ...
                            <td><?php echo isset($parents[1][$vapp['last_cate_id']]) ? '苹果' : '安卓'; ?></td>
