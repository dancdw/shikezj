                    ...
                    <tr>
                        ...
                        <td class="alignleft">
                            <select id="parent_id" name="parent_id" class="ml15">
                                <option value="1" <?php echo !empty($info['parent_id']) && $info['parent_id'] == 1 ? 'selected="selected"' : ''; ?>>苹果</option>
                                <option value="2" <?php echo !empty($info['parent_id']) && $info['parent_id'] == 2 ? 'selected="selected"' : ''; ?>>安卓</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
