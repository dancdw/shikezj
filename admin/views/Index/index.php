...
<div class="gx-login">
    <h1 class="gx-login-title" style="width: 300px; height: 130px;"><!-- <img src="<?php echo static_url('/images/login-title.png'); ?>"> --></h1>
    <h2 class="gx-title-text">试客专家CMS应用市场管理后台 欢迎您登录</h2>
    <p class="gx-small-text">PC端 移动端 为您提供更多的推广方式</p>
