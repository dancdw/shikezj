...
<div class="right_body"> 
    ...
    <div class="mbody">
        ...
        <div class="mt10">
            <form action="<?php echo build_url('Import', 'save', array('info_id' => !empty($info['info_id']) ? $info['info_id'] : 0)); ?>" method="post" id="importForm">
                <table class="tb-2" border="1" bordercolor="#cee1ee">
                    ...
                    <tr>
                        <td class="td-bg">文章上线时间：</td>
                        <td colspan="3" class="alignleft">
                            <input type="text" class="ui_timepicker ipt ml15" id="info_publish_time" name="info_publish_time"  value="<?php echo isset($info['info_publish_time']) ? $info['info_publish_time'] : ''; ?>" />
                            &nbsp;&nbsp;如：请修改你要上线的时间
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="alignleft">
                            ...
                            &nbsp;&nbsp;* 必填 <a href="<?php echo build_url('InfoCategory'); ?>">文章分类</a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <div style="position:relative;">
                                <textarea name="info_body" id="info_body"><?php echo isset($info['info_body']) ? $info['info_body'] : ''; ?></textarea>
                            </div>
                        </td>
                    </tr>
                </table>
...
<script>
    ...
    function save_info()
    {
        ...
        $.post($('#importForm').attr('action'), $('#importForm').serialize(), function(result){
            if (result.code == 0) {
                window.location = '<?php echo build_url("Import"); ?>';
            } else {
                show_msg(result.msg);
            }
        }, 'json');
