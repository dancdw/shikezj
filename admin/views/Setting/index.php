                ...
                <form id="settingForm" name="settingForm" action="<?php echo build_url('Setting', 'save'); ?>" method="post">
                    ...
                    <div class="tab" style="display: none;">
                        <table class="tb-2" style="clear:both;width:100%;" border="1" bordercolor="#cee1ee">
                            ...
                            <tr>
                                <td class="td-bg">微信版模板风格：</td>
                                <td class="alignleft">
                                    <select id="wechat_template" name="wechat_template" class="ml15">
                                        <?php foreach ($templates as $value) : ?>
                                            <?php if(substr($value['name'],0,6) == 'wechat'):?>
                                                <option value="<?php echo $value['name']; ?>" <?php echo $_site['wechat_template'] == $value['name'] ? 'selected="selected"' : ''; ?>>
                                                    <?php echo $value['name']; ?>
                                                </option>
                                            <?php endif;?>
                                        <?php endforeach; ?>
