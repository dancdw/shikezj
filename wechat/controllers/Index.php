...
class Index extends MY_Controller {
	...
	public function __construct()
	{
        ...
        // {
        //     $template_name = $this->_site['wechat_template'];
        // } else {
    ...
    public function app($app_id=0)
    {
        ...
        $cate_type = $category['parent_id'] == 2 ? '苹果' : '安卓';
        ...
        $this->m_counter->addAppView($app_id, $type);
    ...
    public function download($app_id=0)
    {
        ...
        if($this->ua->is_mobile()) {
            $type = 'mobile';
            $upload_file = $app['app_recomment_url'];
        } else {
            $type = 'pc';
        ...
        $this->m_counter->addAppDown($app_id, $type);
